...
public class Logger {
    ...
    /**
     * Viene utilizzato un unico logger chiamato "edu.unito.hdmm.tasl"
     */
     ...
     */
    static {
        logger = java.util.logging.Logger.getLogger("edu.unito.hdmm.tasl");
    ...
    private static java.util.logging.Level selezionaLivello() {
        String livello = System.getProperty("edu.unito.hdmm.tasl.LogLevel");
        logger.fine(livello);
        if (livello != null) {
    ...
    private static java.util.logging.Handler selezionaHandler(){
        ...
        String nomeFile = System.getProperty("edu.unito.hdmm.tasl.LogFile");
